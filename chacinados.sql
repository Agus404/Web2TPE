...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-09-2024 a las 23:38:20
...
INSERT INTO `productos` (`id_producto`, `nombre_producto`, `peso`, `precio`, `id_marca`, `id_categoria`) VALUES
(1, 'Bondiola ahumada', 200, 7000.00, 2, 1),
(2, 'Salamin picado grueso', 150, 4660.00, 1, 2),
(3, 'Jamon crudo tipo Westfalia', 200, 8600.00, 2, 5),
(4, 'Salamin picado fino', 130, 4500.00, 1, 2);
